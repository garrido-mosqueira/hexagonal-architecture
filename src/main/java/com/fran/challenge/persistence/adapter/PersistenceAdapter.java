package com.fran.challenge.persistence.adapter;

import com.fran.challenge.domain.exceptions.NotFoundException;
import com.fran.challenge.domain.model.Task;
import com.fran.challenge.domain.port.CreateTaskPort;
import com.fran.challenge.domain.port.DeleteTaskPort;
import com.fran.challenge.domain.port.ReadTaskPort;
import com.fran.challenge.domain.port.UpdateTaskPort;
import com.fran.challenge.persistence.entities.TaskDocument;
import com.fran.challenge.persistence.mapper.TaskDocumentMapper;
import com.fran.challenge.persistence.repository.TaskRepository;
